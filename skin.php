...
require_once("condb.php");
	 $sqlShow = "SELECT * FROM skin_lesion ORDER BY name ASC";
	 $qryShow = mysql_query($con,$sqlShow);
	 $numShow = mysql_num_rows($qryShow);
	if ($numShow>0) { 
?>
<table border="1"style="margin:200px 0px 0px 500px">
		<tr>
			<th>AGE</th>
			<th>NAME</th>
			<th>DOSES</th>
		</tr>
	<?php while($recShow = mysql_fetch_object($qryShow)){?>
